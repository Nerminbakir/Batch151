...
public class C04_MantikOperatorleri {
    ...
    public static void main(String[] args) {
        ...
        **********   & ile  &&   arasindaki fark    ********
        ...
        cift && (ve) operatoru kodun tamamina bakmadan ilk gordugu False degerinde False dondurur
        Bu nedenle tek & (ve) operatorune gore daha hizli calisir
        Tek & operatoru tum kodu tarar tek bir false var ise false dondurur
        ama bunun icin tum kodun bitmesini bekler.Bu nedenle && operatorune gore daha yavas calisir

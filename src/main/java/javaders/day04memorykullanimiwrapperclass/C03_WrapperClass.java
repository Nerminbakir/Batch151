...
public class C03_WrapperClass {
    ...
    Developerlar sadece data barindiran primitive data typelarinin non primitive ler gibi methodda barindirmasini istemislerdir.
    Bunu uzerine Java primitive data type'larina method ekleyerek; ozel bir class olusturmustur.
    ...
    public static void main(String[] args) {
        ...
        String str1 ="12345";
        String str2 = "678";
        System.out.println(str1+str2);//12345678 concat =birlestirmek
        ...
        String harf = "A";
        int sayi = 7;
        //harf + sayi==> A7 ==>artik 7de String olur
        /*
        8+3+"K"

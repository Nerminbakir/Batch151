...
public class HashMap01 {
    ...
    public static void main(String[] args) {
        ...
        //Loop'lar map'ler ile kullanilamaz. Bunun için entrySet kullanılır. Sadece entry'ler arasinda gezmek istedigimizde loop kullanabiliriz.

        Set<Map.Entry<String, Integer>> entries = countryPopulation.entrySet();
        System.out.println("entries = " + entries);// [Turkiye=83000000, Netherland=18000000, USA=400000000, Germany=83000000, Albania=3000000]

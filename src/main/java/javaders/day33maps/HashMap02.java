...
public class HashMap02 {
    public static void main(String[] args) {
        ...
        // HashMap arkasında calısan mekanizma nasıl calısır? (Interview Question)
        ...
        /*
             ...
             Java key icin 34 hashcode urettigini farzedelim. Bu hashcode'u 16'ya boler. 34:16 kalan 2'yi verir.
             Java kalana odaklanir ve indexi 2 olani bulur, sonra bos kutu olan yani 2.inci indexteki
             bucket'a once hashmap kodu olan 34'u koyar, yanina USA onun yanina Washington'i koyar.
             ...
             codun 16'ya bolunmesi halinde 16 index olarak siralanan bucket'larin disina kalanlar ile cikilmamis olacak.
            ...
            Java bucketlar icinde LinkedList kullanir. Entryleri birbirine node yapısı ile baglar. Indexte birden fazla entry olduysa
            ...
            entry olsa da 82'yi secer ancak hashcode'a dokunmayan java Ankara yerine Istanbul yazar. overwrite yapar.

            Java 12 bucket doldugunda yeni 16 adet bucket verir. Toplam 32 olmus olur. Bundan sonra data için Javanın
            olusturdugu hashcode'u 32'ye boler.*/

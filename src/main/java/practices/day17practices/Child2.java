...
public class Child2 extends Parent2 {
    /*
        Extends yapılan Class'lardaki, tüm constructor'ların ilk satırında biz görmesek bile
        super() constructor call vardır. Dolayısıyla önce parent class'taki constructor calısır.
     */

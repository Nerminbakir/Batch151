package practices.day14practices;
...
public class C01_Varargs {
    ...
    // int, varargs yapmaya gerek yok cunku zaten int 1 tane ama String 1'den fazla oldugu icin String'i Varargs yapıyoruz
    // Bir methodda varargs dısında parametre kullanacaksak once varargs dısındaki parametreler yazılmalı, en son varargs yazılmalıdır

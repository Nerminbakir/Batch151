...
public class StringManipulations {
    public static void main(String[] args) {
        ...
        //System.out.println(str.substring(8, 7)); // Run Time Error

        System.out.println(ss.substring(22)); //a: length()-1 -> son karakter
        System.out.println(ss.substring(23)); //bosluk ...length() -> bos
        //System.out.println(str.substring(24)); // length()'den buyuk sayi yazarsak Run Time Error
        ...
        System.out.println("a harfini @ isareti ile degistir >>> " + ozellik.replace('a', '@')); //h@y@lperest
        ...
        str4=str4.toUpperCase(); // bu satirdan sonra kalici olarak str BUYUK harflerden olusan bir String oldu
